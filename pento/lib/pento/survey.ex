defmodule Pento.Survey do
  ...
  @doc """
  Returns demographic per user.

  ## Examples

      iex> user_atttrs = %{email: "cassandra@griox.io", password: "Tr0yW1llF8ll"}
      iex> {:ok, user} = Accounts.register_user(user_atttrs)
      ...
      %Pento.Survey.Demographic{
        ...
        inserted_at: ~N[2022-11-21 02:12:24],
        updated_at: ~N[2022-11-21 02:12:24]
      }
  """
